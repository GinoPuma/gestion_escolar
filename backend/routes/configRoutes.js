...
router.get('/levels', protect, authorize('Administrador', 'Secretaria'), levelController.getAllLevels);
...
router.get('/grades', protect, authorize('Administrador', 'Secretaria'), gradeController.getAllGrades);
router.get('/grades/level/:levelId', protect, authorize('Administrador', 'Secretaria'), gradeController.getGradesByLevel);
...
router.get('/sections', protect, authorize('Administrador', 'Secretaria'), sectionController.getAllSections);
router.get('/sections/grade/:gradeId', protect, authorize('Administrador', 'Secretaria'), sectionController.getSectionsByGrade);
